BinaryBenchmark <-  function(theData = NULL, theOutcome = "Class", reps = 100, trainFraction = 0.5,referenceCV = NULL,referenceName = "Reference",referenceFilterName="Reference")
{
  ...
  FilterMethod <-  function(clasfun = e1071::svm, classname = "", center = FALSE, ...)
  {
    ...
    cStats <- predictionStats_binary(rcvFilter_reference$medianTest,"", center = center);
    ...
    cStats <- predictionStats_binary(rcvFilter_LASSO$medianTest,"", center = center);
    accciTable_filter <- rbind(accciTable_filter,cStats$accc)
    errorciTable_filter <- rbind(errorciTable_filter,cStats$berror)
    aucTable_filter <- rbind(aucTable_filter,cStats$aucs)
    senTable_filter <- rbind(senTable_filter,cStats$sensitivity)
    ...
    cStats <- predictionStats_binary(rcvFilter_RPART$medianTest,"", center = center);
    accciTable_filter <- rbind(accciTable_filter,cStats$accc)
    errorciTable_filter <- rbind(errorciTable_filter,cStats$berror)
    aucTable_filter <- rbind(aucTable_filter,cStats$aucs)
    senTable_filter <- rbind(senTable_filter,cStats$sensitivity)
    ...
    cStats <- predictionStats_binary(rcvFilter_RF$medianTest,"", center = center);
    accciTable_filter <- rbind(accciTable_filter,cStats$accc)
    errorciTable_filter <- rbind(errorciTable_filter,cStats$berror)
    aucTable_filter <- rbind(aucTable_filter,cStats$aucs)
    senTable_filter <- rbind(senTable_filter,cStats$sensitivity)
    ...
    cStats <- predictionStats_binary(rcvFilter_IDI$medianTest,"", center = center);
    accciTable_filter <- rbind(accciTable_filter,cStats$accc)
    errorciTable_filter <- rbind(errorciTable_filter,cStats$berror)
    aucTable_filter <- rbind(aucTable_filter,cStats$aucs)
    senTable_filter <- rbind(senTable_filter,cStats$sensitivity)
    ...
    cStats <- predictionStats_binary(rcvFilter_NRI$medianTest,"", center = center);
    accciTable_filter <- rbind(accciTable_filter,cStats$accc)
    errorciTable_filter <- rbind(errorciTable_filter,cStats$berror)
    aucTable_filter <- rbind(aucTable_filter,cStats$aucs)
    senTable_filter <- rbind(senTable_filter,cStats$sensitivity)
    ...
    cStats <- predictionStats_binary(rcvFilter_tStudent$medianTest,"", center = center);
    accciTable_filter <- rbind(accciTable_filter,cStats$accc)
    errorciTable_filter <- rbind(errorciTable_filter,cStats$berror)
    aucTable_filter <- rbind(aucTable_filter,cStats$aucs)
    senTable_filter <- rbind(senTable_filter,cStats$sensitivity)
    ...
    cStats <- predictionStats_binary(rcvFilter_wilcox$medianTest,"", center = center);
    accciTable_filter <- rbind(accciTable_filter,cStats$accc)
    errorciTable_filter <- rbind(errorciTable_filter,cStats$berror)
    aucTable_filter <- rbind(aucTable_filter,cStats$aucs)
    senTable_filter <- rbind(senTable_filter,cStats$sensitivity)
   ...
   cStats <- predictionStats_binary(rcvFilter_kendall$medianTest,"", center = center);
    accciTable_filter <- rbind(accciTable_filter,cStats$accc)
    errorciTable_filter <- rbind(errorciTable_filter,cStats$berror)
    aucTable_filter <- rbind(aucTable_filter,cStats$aucs)
    senTable_filter <- rbind(senTable_filter,cStats$sensitivity)
    ...
    cStats <- predictionStats_binary(rcvFilter_mRMR$medianTest,"", center = center);
    accciTable_filter <- rbind(accciTable_filter,cStats$accc)
    errorciTable_filter <- rbind(errorciTable_filter,cStats$berror)
    aucTable_filter <- rbind(aucTable_filter,cStats$aucs)
    senTable_filter <- rbind(senTable_filter,cStats$sensitivity)
...
######################Classification Algorithms####################################  
  ...
  cStats <- predictionStats_binary(referenceCV$medianTest,plotname = referenceName,cex=0.8);
  ...
  cStats <- predictionStats_binary(rcvRF$medianTest,plotname = "Random Forest",center = TRUE,cex=0.8);
  accciTable <- rbind(accciTable,cStats$accc)
  errorciTable <- rbind(errorciTable,cStats$berror)
  aucTable <- rbind(aucTable,cStats$aucs)
  senTable <- rbind(senTable,cStats$sensitivity)
  ...
  cStats <- predictionStats_binary(rcvRPART$medianTest,plotname = "RPART",center = TRUE,cex=0.8);
  accciTable <- rbind(accciTable,cStats$accc)
  errorciTable <- rbind(errorciTable,cStats$berror)
  aucTable <- rbind(aucTable,cStats$aucs)
  senTable <- rbind(senTable,cStats$sensitivity)
  ...
  cStats <- predictionStats_binary(rcvLASSO$medianTest,plotname = "LASSO",center = FALSE,cex=0.8);
  accciTable <- rbind(accciTable,cStats$accc)
  errorciTable <- rbind(errorciTable,cStats$berror)
  aucTable <- rbind(aucTable,cStats$aucs)
  senTable <- rbind(senTable,cStats$sensitivity)
  ...
  cStats <- predictionStats_binary(rcvSVM$medianTest,plotname = "SVM",center = TRUE,cex=0.8);
  accciTable <- rbind(accciTable,cStats$accc)
  errorciTable <- rbind(errorciTable,cStats$berror)
  aucTable <- rbind(aucTable,cStats$aucs)
  senTable <- rbind(senTable,cStats$sensitivity)
  ...
  cStats <- predictionStats_binary(rcvKNN$medianTest,plotname = "KNN",center = TRUE,cex=0.8);
  accciTable <- rbind(accciTable,cStats$accc)
  errorciTable <- rbind(errorciTable,cStats$berror)
  aucTable <- rbind(aucTable,cStats$aucs)
  senTable <- rbind(senTable,cStats$sensitivity)
...
# Method Meta Ensemble  
  ...
  ens <- cbind(referenceCV$medianTest[,1],rowMeans(cbind(1.0*(referenceCV$medianTest[,2] > 0),1.0*(rcvLASSO$medianTest[,2] > 0),rcvRF$medianTest[,2],rcvKNN$medianTest[,2],rcvSVM$medianTest[,2])))
  cStats <- predictionStats_binary(ens,plotname = "ENS",center = TRUE,cex=0.8);
  accciTable <- rbind(accciTable,cStats$accc)
  errorciTable <- rbind(errorciTable,cStats$berror)
  aucTable <- rbind(aucTable,cStats$aucs)
  senTable <- rbind(senTable,cStats$sensitivity)
...
######################Filters  ####################################  
  ...
  result <- list(errorciTable = errorciTable,accciTable = accciTable,aucTable = aucTable,senTable = senTable,speTable = speTable,
                 errorciTable_filter = errorciTable_filter,accciTable_filter = accciTable_filter,aucTable_filter = aucTable_filter,senciTable_filter = senciTable_filter,speciTable_filter = speciTable_filter,
